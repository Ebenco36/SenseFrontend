<template>
  <v-app>
    ...
    <AdvancedFilterDialog v-show="dialog" v-model="dialog" :initial-filters="currentAdvancedFilters"
...
const AdvancedFilterDialog = defineAsyncComponent(() => import('@/components/AdvancedFilterDialog.vue'));
